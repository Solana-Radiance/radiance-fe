...
vitest_1.describe("runStats", () => {
    ...
    vitest_1.it("runStats startedAt is Date type", () => __awaiter(void 0, void 0, void 0, function* () {
        var _a;
        vitest_1.assert.typeOf((_a = queryResultSet.runStats) === null || _a === void 0 ? void 0 : _a.startedAt, "Date");
    }));
    vitest_1.it("runStats endedAt is Date type", () => __awaiter(void 0, void 0, void 0, function* () {
        var _b;
        vitest_1.assert.typeOf((_b = queryResultSet.runStats) === null || _b === void 0 ? void 0 : _b.startedAt, "Date");
    }));
    vitest_1.it("runStats recordCount = 4", () => __awaiter(void 0, void 0, void 0, function* () {
        var _c;
        vitest_1.assert.equal((_c = queryResultSet.runStats) === null || _c === void 0 ? void 0 : _c.recordCount, 4);
    }));
    vitest_1.it("runStats elpasedSeconds = 90", () => __awaiter(void 0, void 0, void 0, function* () {
        var _d;
        vitest_1.assert.equal((_d = queryResultSet.runStats) === null || _d === void 0 ? void 0 : _d.elapsedSeconds, 90);
    }));
});
vitest_1.describe("records", () => {
    const queryResultSet = new query_result_set_builder_1.QueryResultSetBuilder(getQueryResultSetBuilder(types_1.QueryStatusFinished));
    vitest_1.it("records length = rows length", () => __awaiter(void 0, void 0, void 0, function* () {
        var _a, _b;
    ...
    vitest_1.it("columns length = records keys length", () => {
        var _a;
    ...
    vitest_1.it("columns = record keys", () => {
        var _a, _b;
    ...
    vitest_1.it("record values match row values", () => {
        var _a;
...
vitest_1.describe("status", () => {
    vitest_1.it("isFinished", () => __awaiter(void 0, void 0, void 0, function* () {
        const queryResultSet = new query_result_set_builder_1.QueryResultSetBuilder(getQueryResultSetBuilder(types_1.QueryStatusFinished));
        vitest_1.assert.equal(queryResultSet === null || queryResultSet === void 0 ? void 0 : queryResultSet.status, types_1.QueryStatusFinished);
    }));
    vitest_1.it("isPending", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    vitest_1.it("isError", () => __awaiter(void 0, void 0, void 0, function* () {
...
vitest_1.describe("queryID", () => {
    vitest_1.it("queryId is set", () => __awaiter(void 0, void 0, void 0, function* () {
        const queryResultSet = new query_result_set_builder_1.QueryResultSetBuilder(getQueryResultSetBuilder(types_1.QueryStatusFinished));
        vitest_1.assert.notEqual(queryResultSet === null || queryResultSet === void 0 ? void 0 : queryResultSet.queryId, null);
    }));
    vitest_1.it("queryId is test", () => __awaiter(void 0, void 0, void 0, function* () {
        const queryResultSet = new query_result_set_builder_1.QueryResultSetBuilder(getQueryResultSetBuilder(types_1.QueryStatusFinished));
