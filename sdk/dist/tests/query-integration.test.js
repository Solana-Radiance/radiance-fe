...
vitest_1.describe("run: server_error", () => {
    vitest_1.it("#createQuery server error", () => __awaiter(void 0, void 0, void 0, function* () {
        var _a, _b;
        const api = api_mocks_1.getMockApiClient({
    ...
    vitest_1.it("#getQueryResult server error", () => __awaiter(void 0, void 0, void 0, function* () {
        var _c, _d;
        const api = api_mocks_1.getMockApiClient({
...
vitest_1.describe("run: user_error", () => {
    vitest_1.it("#createQuery user error", () => __awaiter(void 0, void 0, void 0, function* () {
        var _a, _b;
        const api = api_mocks_1.getMockApiClient({
    ...
    vitest_1.it("#getQueryResult user error", () => __awaiter(void 0, void 0, void 0, function* () {
        var _c, _d;
        const api = api_mocks_1.getMockApiClient({
            createQueryResp: createQueries.noError,
    ...
    vitest_1.it("#getQueryResult sql exec error", () => __awaiter(void 0, void 0, void 0, function* () {
        var _e, _f;
        const api = api_mocks_1.getMockApiClient({
            createQueryResp: createQueries.noError,
...
vitest_1.describe("run: timeout_error", () => {
    vitest_1.it("query is pending", () => __awaiter(void 0, void 0, void 0, function* () {
        var _a, _b;
        const api = api_mocks_1.getMockApiClient({
            createQueryResp: createQueries.noError,
            getQueryResultResp: getQueryResult.noErrorPending,
    ...
    vitest_1.it("query is rate limited", () => __awaiter(void 0, void 0, void 0, function* () {
        var _c, _d;
        const api = api_mocks_1.getMockApiClient({
