...
class QueryIntegration {
    ...
    run(query) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [getQueryResultJson, getQueryErr] = yield __classPrivateFieldGet(this, _QueryIntegration_instances, "m", _QueryIntegration_getQueryResult).call(this, createQueryJson.token);
            if (getQueryErr) {
                return new query_result_set_builder_1.QueryResultSetBuilder({
                    queryResultJson: null,
                    error: getQueryErr,
...
}, _QueryIntegration_getQueryResult = function _QueryIntegration_getQueryResult(queryID, attempts = 0) {
    return __awaiter(this, void 0, void 0, function* () {
        const resp = yield __classPrivateFieldGet(this, _QueryIntegration_api, "f").getQueryResult(queryID);
        //ignore server time out
        if (resp.statusCode > 299 && resp.statusCode !== 504) {
            if (resp.statusCode >= 400 && resp.statusCode <= 499) {
        ...
        return __classPrivateFieldGet(this, _QueryIntegration_instances, "m", _QueryIntegration_getQueryResult).call(this, queryID, attempts + 1);
    });
};
